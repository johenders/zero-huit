...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    {
      url: `${siteUrl}/municipal`,
      lastModified: now,
      changeFrequency: "monthly",
      priority: 0.7,
    },
    {
      url: `${siteUrl}/production-video-sante`,
      lastModified: now,
      changeFrequency: "monthly",
      priority: 0.7,
    },
    {
      url: `${siteUrl}/production-video-sante/dossier`,
      lastModified: now,
      changeFrequency: "monthly",
      priority: 0.5,
    },
    {
      url: `${siteUrl}/recrutement`,
      lastModified: now,
      changeFrequency: "monthly",
      priority: 0.7,
    },
    ...
    {
      url: `${siteUrl}/en/demandedepaiement`,
      lastModified: now,
      changeFrequency: "monthly",
      priority: 0.6,
    },
    ...
    {
      url: `${siteUrl}/en/production-video-rive-sud-mtl`,
      lastModified: now,
      changeFrequency: "monthly",
      priority: 0.7,
    },
    {
      url: `${siteUrl}/en/evenements`,
      lastModified: now,
      changeFrequency: "monthly",
      priority: 0.7,
    },
    {
      url: `${siteUrl}/en/municipal`,
      lastModified: now,
      changeFrequency: "monthly",
      priority: 0.7,
    },
    {
      url: `${siteUrl}/en/production-video-sante`,
      lastModified: now,
      changeFrequency: "monthly",
      priority: 0.7,
    },
    {
      url: `${siteUrl}/en/production-video-sante/dossier`,
      lastModified: now,
      changeFrequency: "monthly",
      priority: 0.5,
    },
    {
      url: `${siteUrl}/en/recrutement`,
      lastModified: now,
      changeFrequency: "monthly",
      priority: 0.7,
    },
