  ...
  return (
    <main className="mx-auto w-full max-w-3xl space-y-8 px-6 py-16 text-white">
      <header className="space-y-2">
        ...
        <p className="text-sm text-white/70">Last updated: January 29, 2026</p>
      </header>
      ...
      <section className="space-y-2 text-sm text-white/80">
        ...
        <p>
          Contact: <strong>To be completed</strong>
          <br />
          Title: <strong>To be completed</strong>
          <br />
      ...
      <section className="space-y-2 text-sm text-white/80">
        ...
        <p>
          ...
          described above, then delete or anonymize it.
        </p>
      </section>
